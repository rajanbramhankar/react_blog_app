    ...
    <section>
      <div className='home_top'>
        ...
        {response.filter((e) => (e.category === "Tourism" && e.id === "god")).map((c) => {
          return (<Link to='/Tourism'><img className='top_img_home' src={c.image}  alt="sdrfg"  /></Link>)
        })
        }
        <div className='Extra_div_home'>
          {response.filter((e) => (e.category === "Sports" && e.id === "35")).map((c) => {
            return (<Link to='/Sport'><img className='top_img_home_1' src={c.image} alt="fgs" /></Link>

            )
          })
          }
          {response.filter((e) => (e.category === "Technology" && e.id === "27")).map((c) => {
            return (<Link to='/Technology'><img className='top_img_home_1' src={c.image} alt="sfdg" /></Link>)
          })
          }
        </div>
